...
public class DumpContactFunction extends GhidraScript {
    ...
    private void dumpReferences(Address target, String indent) {
        ...
        while (references.hasNext()) {
            if (shown++ == 64) {
                println(indent + "XREF list capped at 64; query specific callers separately");
                break;
            }
    ...
    private void dumpFunction(DecompInterface decompiler, long rva) throws Exception {
        ...
        Function function = getFunctionContaining(requested); if (function == null) { disassemble(requested); function = createFunction(requested, null); }
